...
# 
# Siga este documento orientador para saber como organizar-se para a avaliação do Módulo 1 da disciplina.
# 
# ## Orientações Gerais
# 
# ### Definição 
# 
# A Análise de Caso de Visualização de Dados (ACVD) é um método baseado em análise crítica e julgamento de representações visuais aplicáveis a diversos segmentos, tais como educação, esporte, indústria e serviços.
# 
# ### Objetivo 
# 
# Analisar representações visuais reais sob o ponto de vista dos princípios fundamentais teóricos e técnicos da visualização de dados cobertos na disciplina.
# 
# ### Escopo
# 
