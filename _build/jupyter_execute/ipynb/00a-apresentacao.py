...
# 
# - Conteúdo (18h)
#     - [Introdução à Visualização de Dados](01-introducao.ipynb) 
#     - [Marcos Históricos da Visualização de Dados](02-historico.ipynb) 
#     - [Criação de Representações Visuais e Estética](03-estetica.ipynb) 
#     - [Eixos, Escalas e Sistemas de Coordenadas](04-eixos.ipynb) 
#     - [Percepção Visual](05-percepcao.ipynb) 
#     - [Cores](06-cores.ipynb)
#     - [_Lounge_ das Representações Visuais](07-lounge.ipynb)
#     - [Técnicas de _Storytelling_](08-storytelling.ipynb)
#     - [Imersão em _matplotlib_](09-matplotlib-imersao.ipynb)
# - Avaliação (2h)
